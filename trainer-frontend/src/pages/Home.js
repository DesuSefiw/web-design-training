      ...
      <section className="why-join">
        ...
        <div className="benefits-grid">
          ...
          <div className="benefit-card">
            <span>🏗️</span>
            <h3>Real Projects</h3>
            <p>Learn by building real-world websites and apps.</p>
          </div>
          <div className="benefit-card">
            <span>⚛️</span>
            <h3>Modern Tools</h3>
          ...
          <div className="benefit-card">
            <span>🌙</span>
            <h3>Night Classes</h3>
            <p>Perfect timing for students and professionals.</p>
          </div>
          <div className="benefit-card">
            <span>🏠</span>
            <h3>Remote Learning</h3>
            <p>Join from anywhere with live interactive support.</p>
          </div>
          <div className="benefit-card">
            <span>🎯</span>
            <h3>Hands-on Learning</h3>
            <p>Practical, project-based approach ensures deep learning.</p>
          </div>
        </div>
      </section>
        <Footer />
